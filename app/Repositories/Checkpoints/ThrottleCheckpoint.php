...
use App\Repositories\Throttling\ThrottleRepositoryInterface;
...
class ThrottleCheckpoint implements CheckpointInterface
{
     ...
     *
     * @var \App\Repositories\Throttling\ThrottleRepositoryInterface
     */
    protected $throttle;
    ...
    /**
     * The user agent, used for checkpoints.
     *
     * @var string
     */
    protected $userAgent;
    ...
    /**
     * The email used for checkpoints.
     *
     * @var string
     */
    protected $email;
    ...
    /**
     * The password used for checkpoints.
     *
     * @var string
     */
    protected $password;
     ...
     * Constructor.
     *
     * @param \App\Repositories\Throttling\ThrottleRepositoryInterface $throttle
    ...
    public function fail(UserInterface $user = null)
    {
        ...
        $this->throttle->log($this->ipAddress, $this->userAgent, $this->email, $this->password, $user);
    }
     ...
     *
     * @param string                                     $action
     * @param \App\Repositories\Users\UserInterface|null $user
     *
     * @return bool
     */
     ...
     * @param int    $delay
     *
     * @throws \App\Repositories\Checkpoints\ThrottlingException
     */
