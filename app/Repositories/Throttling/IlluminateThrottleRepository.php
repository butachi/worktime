...
class IlluminateThrottleRepository implements ThrottleRepositoryInterface
{
    ...
    public function __construct(
        $model = 'App\Repositories\Throttling\EloquentThrottle',
        $globalInterval = null,
    ...
    public function log($ipAddress = null, $userAgent = null, $email = null, $password = null, UserInterface $user = null)
    {
        ...
        $throttle->fill([
            ...
            'email' => $user !== null ? $user->getUserLogin() : $email,
            'password' => $password,
        ]);
        $throttle->save();
    }
     ...
     *
     * @param \App\Repositories\Throttling\EloquentThrottle $throttle
     * @param int                                           $interval
     *
     * @return int
     */
    ...
    {
        return $throttle->created_at_jp->addSeconds($interval)->diffInSeconds();
    }
}
